---
title: "How to use LPSC?"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How to use LPSC}
...
Note: The codes for this package have been rewritten due to the extensive change in 2023 database.
